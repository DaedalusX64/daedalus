...
void	CAssemblyWriterPSP::GetLoadConstantOps( EPspReg reg, s32 value, PspOpCode * p_op1, PspOpCode * p_op2 )
{
	...
	{
		// ORI
		op1.op = static_cast<u32>(OpCodeValue::OP_ADDIU);
		op1.rt = reg;
		op1.rs = PspReg_R0;
	...
	else
	{
		...
		op1.op = static_cast<u32>(OpCodeValue::OP_LUI);
		op1.rt = reg;
		op1.rs = PspReg_R0;
		...
		if ( u16( value ) != 0 )
		{
			op2.op = static_cast<u32>(OpCodeValue::OP_ORI);
			op2.rt = reg;
			op2.rs = reg;
...
{
	StoreRegister( reg_src, OpCodeValue::OP_SW, reg_base, offset );
}
...
{
	StoreRegister( reg_src, OpCodeValue::OP_SH, reg_base, offset );
}
...
{
	StoreRegister( reg_src, OpCodeValue::OP_SB, reg_base, offset );
}
...
{
	LoadRegister( reg_dst, OpCodeValue::OP_LB, reg_base, offset );
}
...
{
	LoadRegister( reg_dst, OpCodeValue::OP_LBU, reg_base, offset );
}
...
{
	LoadRegister( reg_dst, OpCodeValue::OP_LH, reg_base, offset );
}
...
{
	LoadRegister( reg_dst, OpCodeValue::OP_LHU, reg_base, offset );
}
...
{
	LoadRegister( reg_dst, OpCodeValue::OP_LW, reg_base, offset );
}
...
void	CAssemblyWriterPSP::LWC1( EPspFloatReg reg_dst, EPspReg reg_base, s16 offset )
{
	...
	op_code.op = static_cast<u32>(OpCodeValue::OP_LWC1);
	op_code.ft = reg_dst;
	op_code.base = reg_base;
	op_code.immediate = offset;
...
void	CAssemblyWriterPSP::SWC1( EPspFloatReg reg_src, EPspReg reg_base, s16 offset )
{
	...
	op_code.op = static_cast<u32>(OpCodeValue::OP_SWC1);
	op_code.ft = reg_src;
	op_code.base = reg_base;
	op_code.immediate = offset;
	AppendOp( op_code );
...
{
	PspOpCode	op_code {};
	op_code.op = static_cast<u32>(OpCodeValue::OP_LUI);
	op_code.rt = reg;
...
CJumpLocation	CAssemblyWriterPSP::JAL( CCodeLabel target, bool insert_delay )
{
	...
	PspOpCode	op_code {};
	op_code._u32 = 0;
	op_code.op = static_cast<u32>(OpCodeValue::OP_JAL);
...
{
	return BranchOp( a, OpCodeValue::OP_BNE, b, target, insert_delay );
}
...
{
	return BranchOp( a, OpCodeValue::OP_BEQ, b, target, insert_delay );
}
...
{
	return BranchOp( a, OpCodeValue::OP_BNEL, b, target, insert_delay );
}
...
{
	return BranchOp( a, OpCodeValue::OP_BEQL, b, target, insert_delay );
}
...
{
	return BranchOp( a, OpCodeValue::OP_BLEZ, PspReg_R0, target, insert_delay );
}
...
{
	return BranchOp( a, OpCodeValue::OP_BGTZ, PspReg_R0, target, insert_delay );
}
...
void	CAssemblyWriterPSP::ADDI( EPspReg reg_dst, EPspReg reg_src, s16 value )
{
	PspOpCode	op_code {};
	op_code._u32 = 0;
	op_code.op = static_cast<u32>(OpCodeValue::OP_ADDI);
	op_code.rt = reg_dst;
	op_code.rs = reg_src;
	op_code.immediate = value;
	AppendOp( op_code );
...
void	CAssemblyWriterPSP::ADDIU( EPspReg reg_dst, EPspReg reg_src, s16 value )
{
	PspOpCode	op_code {};
	op_code._u32 = 0;
	op_code.op = static_cast<u32>(OpCodeValue::OP_ADDIU);
	op_code.rt = reg_dst;
	op_code.rs = reg_src;
	op_code.immediate = value;
	AppendOp( op_code );
...
void	CAssemblyWriterPSP::SLTI( EPspReg reg_dst, EPspReg reg_src, s16 value )
{
	PspOpCode	op_code {};
	op_code._u32 = 0;
	op_code.op = static_cast<u32>(OpCodeValue::OP_SLTI);
	op_code.rt = reg_dst;
	op_code.rs = reg_src;
	op_code.immediate = value;
	AppendOp( op_code );
...
void	CAssemblyWriterPSP::SLTIU( EPspReg reg_dst, EPspReg reg_src, s16 value )
{
	PspOpCode	op_code {};
	op_code._u32 = 0;
	op_code.op = static_cast<u32>(OpCodeValue::OP_SLTIU);
	op_code.rt = reg_dst;
	op_code.rs = reg_src;
	op_code.immediate = value;
	AppendOp( op_code );
...
void	CAssemblyWriterPSP::ANDI( EPspReg reg_dst, EPspReg reg_src, u16 immediate )
{
	PspOpCode	op_code {};
	op_code._u32 = 0;
	op_code.op = static_cast<u32>(OpCodeValue::OP_ANDI);
	op_code.rt = reg_dst;
	op_code.rs = reg_src;
...
void	CAssemblyWriterPSP::ORI( EPspReg reg_dst, EPspReg reg_src, u16 immediate )
{
	PspOpCode	op_code {};
	op_code._u32 = 0;
	op_code.op = static_cast<u32>(OpCodeValue::OP_ORI);
	op_code.rt = reg_dst;
	op_code.rs = reg_src;
	op_code.immediate = immediate;
	AppendOp( op_code );
...
void	CAssemblyWriterPSP::XORI( EPspReg reg_dst, EPspReg reg_src, u16 immediate )
{
	PspOpCode	op_code {};
	op_code._u32 = 0;
	op_code.op = static_cast<u32>(OpCodeValue::OP_XORI);
	op_code.rt = reg_dst;
	op_code.rs = reg_src;
	op_code.immediate = immediate;
	AppendOp( op_code );
...
void	CAssemblyWriterPSP::CFC1( EPspReg rt, EPspFloatReg fs )
{
	...
	op_code.rt = rt;
	op_code.fs = fs;
	op_code.cop1_op = static_cast<u32>(ECop1Op::Cop1Op_CFC1);
	AppendOp( op_code );
}
...
void	CAssemblyWriterPSP::MFC1( EPspReg rt, EPspFloatReg fs )
{
	...
	op_code.rt = rt;
	op_code.fs = fs;
	op_code.cop1_op = static_cast<u32>(ECop1Op::Cop1Op_MFC1);
	AppendOp( op_code );
}
...
void	CAssemblyWriterPSP::MTC1( EPspFloatReg fs, EPspReg rt )
{
	...
	op_code.rt = rt;
	op_code.fs = fs;
	op_code.cop1_op = static_cast<u32>(ECop1Op::Cop1Op_MTC1);
	AppendOp( op_code );
}
...
{
	Cop1Op( ECop1Op::Cop1Op_SInstr, PspFloatReg_F00, fs, cmp_op, ft );
}
