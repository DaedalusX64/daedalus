...
,	mIsFinished( false )
{
	...
	mElements.Add( new CBoolSetting( &mRomPreferences.DynarecDoublesOptimisation, "Dynamic Doubles Optimisation", "Enable for speed-up (WARNING, Works on most but not all ROMs).", "Enabled", "Disabled" ) );
