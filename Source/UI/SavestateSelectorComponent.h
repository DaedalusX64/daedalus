...
class CSavestateSelectorComponent : public CUIComponent
{
	public:
		...
		static CSavestateSelectorComponent *	Create( CUIContext * p_context, EAccessType access_type, std::function<void( const char *)> on_savestate_selected, const char *running_rom );
		void LoadState();
		void SaveState();
};
